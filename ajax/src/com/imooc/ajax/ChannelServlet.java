	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(level.equals("1")) {
			...
			if(parent.equals("ai")) {
				...
				chlist.add(new Channel("bitebi" , "比特币"));
				chlist.add(new Channel("jiqixuexi" , "机器学习"));
				chlist.add(new Channel("shenduxuexi" , "深度学习"));
				chlist.add(new Channel("other" , "..."));
			}else if(parent.equals("web")){
				chlist.add(new Channel("html" , "HTML"));
				chlist.add(new Channel("css" , "CSS"));
				chlist.add(new Channel("js" , "JavaScript"));
				chlist.add(new Channel("jsp	" , "JSP"));
				chlist.add(new Channel("other" , "..."));
			}
		}
		//进行序列化
